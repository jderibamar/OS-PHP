                 ...
                 <div class="card shadow mb-4">
                     ...
                     <div class="card-body">
                            <form class="user" action="" id="form" name="form_edit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                                    ...
                                                    <?php if (isset($venda_produtos)): ?>
                                                            ...
                                                            <?php foreach ($venda_produtos as $venda_produto): ?>
                                                                ...
                                                                <tr>                                                    
                                                                    ...
                                                                    <td><input title="Descrição do produto" type="text" name="produto_descricao[]" value="<?= $venda_produto->produto_descricao; ?>" class="produto_descricao form-control form-control-user input-sm" data-cell="B<?php echo $i; ?>" readonly></td>
                                                                    <td><input title="Valor unitário do produto" name="venda_produto_valor_unitario[]" value="<?= $venda_produto->venda_produto_valor_unitario; ?>" class="form-control form-control-user input-sm text-right pr-1" data-cell="C<?php echo $i; ?>" readonly></td>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="id_vendedor" class="custom-select vendedor" name="venda_vendedor_id" required="">
                                                        <?php foreach ($vendedores as $vendedor): ?>
                                                            <option value="<?php echo $vendedor->vendedor_id; ?>" <?php echo ($vendedor->vendedor_id == $venda->venda_vendedor_id ? 'selected' : '') ?> ><?php echo $vendedor->vendedor_nome_completo . ' | ' . $vendedor->vendedor_matricula; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                    ...
                                    <div class="mt-3">
                                        <button class="btn btn-primary btn-sm mr-2" id="btn-cadastrar-venda" form="form" <?= $desabilitar == TRUE ? 'disabled' : ''; ?>><?= $desabilitar == TRUE ? 'Encerrada' : 'Salvar' ?></button>
