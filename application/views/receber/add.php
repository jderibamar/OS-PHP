                         ...
                         <form method="POST" name="form_edit" class="user">
                                    <div class="form-group row">
                                         ...
                                         <div class="col-md-2 form-text mb-1">  
                                                ...
                                                <input type="text" id="data_vencimento" class="form-control form-control-user-date" name="conta_receber_data_vencimento" value="<?= set_value('conta_receber_data_vencimento')  ?>" >
                                                <?= form_error('conta_receber_data_vencimento', '<small class="form-text text-danger" >', '</small>')  ?>
                                         </div>

<!--                                         <div class="col-md-2 form-text mb-1">  
                                                <label> Data de pagamento </label>
                                                <input type="text" class="form-control form-control-user-date" name="conta_receber_data_pagamento" value="<?= set_value('conta_receber_data_pagamento') ?>" >
                                                <?= form_error('conta_receber_data_pagamento', '<small class="form-text text-danger" >', '</small>')  ?>
                                         </div>-->

                                         <div class="col-md-2 form-text mb-1">  
                                                <label> Valor da conta </label>
                                                <input type="text" class="form-control form-control-user money" name="conta_receber_valor" value="<?= set_value('conta_receber_valor') ?>" >
                                  ...
                                  <div class="form-group row">
                                         <div class="col-md-12 form-text mb-1">  
                                                ...
                                                <textarea class="form-control" name="conta_receber_obs"><?= set_value('conta_receber_obs') ?></textarea>
                                         </div>
                                  </div>
