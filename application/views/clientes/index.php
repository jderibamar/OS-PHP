                             ...
                             <tbody>
                                 <?php foreach($clientes as $cliente): ?>
                                     <tr>
                                         ...
                                         <td class="pr-4"> <?= ($cliente->cliente_tipo == 1 ? 'Pessoa física' : 'Pesso jurídica') ?> </td>
                                         <td class="text-center"> <?= ($cliente->cliente_ativo == 1 ? '<span class="badge badge-info btn-sm"> Sim </span>' : '<span class="badge badge-warning btn-sm"> Não </span>') ?> </td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Confirma exclusão deste cliente?</h5>
