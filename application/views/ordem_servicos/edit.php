                     ...
                     <div class="card-body">
                            <form class="user" action="" id="form" name="form_edit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                                    ...
                                                    <tbody id="lista_servicos" class="">
                                                        ...
                                                        <?php if (isset($os_tem_servicos)): ?>
                                                            ...
                                                            <?php foreach ($os_tem_servicos as $os_servico): ?>
                                                                ...
                                                                <tr>
                                                                    <td><input type="hidden" name="servico_id[]" value="<?= $os_servico->ordem_ts_id_servico ?>" data-cell="A<?= $i; ?>" data-format="0" readonly></td>
                                                                    <td><input title="Descrição do servico" type="text" name="servico_descricao[]" value="<?= $os_servico->servico_descricao ?>" class="servico_descricao form-control form-control-user input-sm" data-cell="B<?= $i; ?>" readonly></td>
                                                                    <td><input title="Valor unitário do servico" name="servico_preco[]" value="<?= $os_servico->ordem_ts_valor_unitario ?>" class="form-control form-control-user input-sm text-right money pr-1" data-cell="C<?php echo $i; ?>" readonly></td>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <a href="<?php echo base_url('os'); ?>" class="btn btn-success btn-sm">Voltar</a>
                                    </div>
                          </form>  
                     </div>
                 </div>
